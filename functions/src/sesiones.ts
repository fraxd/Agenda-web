...
export class sesiones {
    ...
    newSesion(db:admin.firestore.Firestore,uidUnico:string,especialidad:string,monto:number,uidEvento:string,uidProfesional:string,nombreProfesional:string,timeStart:string,timeEnd:string,uidPaciente:string){
